 ...
 <section style="padding: 20px;" class="popular" id="popular">
      ...
      <div class="box-container">
          ...
          <div class="box">
              ...
              <h3>PANI PURI</h3>
              <a href="panipuri.php" class="btn">View More</a>
          </div>
          <div class="box">

              <img src="./images/Pav-Bhaji-Recipe.jpg" alt="">
              <h3>PAV BHAJI</h3>
              <a href="pavbaji.php" class="btn">View More</a>
          </div>
          <div class="box">

              <img src="./images/pizza.jpg" alt="">
              <h3>PIZZA</h3>
              <a href="pizza.php" class="btn">View More</a>
          </div>
          <div class="box">

              <img src="./images/veg_sandwich.jpg" alt="">
              <h3>VEG SANDWICH</h3>
              <a href="sandwich.php" class="btn">View More</a>
          </div>
          <div class="box">

              <img src="./images/veg manchuria.jpg" alt="">
              <h3>VEG MANCHURIAN</h3>
              <a href="manchuria.php" class="btn">View More</a>
          </div>
          <div class="box">

              <img src="./images/yum-veggie-burger.png" alt="">
              <h3>VEG BURGER</h3>
              <a href="burger.php" class="btn">View More</a>
          </div>
