...
<div class="wrapper">
  <div class="img">
        <img src="./images/carrotjuice.jpg">
  ...
  <div id="ingredients" class="tabcontent">
          ...
          <ul>
        <li style="font-size: 23px;padding: 10px;">500 grams carrots fresh & tender.</li>
          <li style="font-size: 23px;padding: 10px;"><sup>1</sup>&frasl;<sub>2 </sub>lemon small,(skip if using sour apples)</li>
          <li style="font-size: 23px;padding: 10px;">1 cup water(if making in a blender).</li>
          <li style="font-size: 23px;padding: 10px;">1 <sup>1</sup>&frasl;<sub>2 </sub>inch ginger piece.</li>
          <li style="font-size: 23px;padding: 10px;">3 oranges or 2 to 3 pears or 5 to 6 tangerians or 2 lemons.</li>
      </ul>
        </div>
        <div id="directions" class="tabcontent">
          <h3 style="color: orange;font-size: 40px;">DIRECTIONS</h3>
          <li style="font-size: 23px;padding: 10px;">Wash carrots under running water.Use a vegetable scrub or brush to clean them,Rinse Well.</li>
      <li style="font-size: 23px;padding: 10px;">Soak them in a large pot fiiled with clean water for 30 mins.</li>
      <li style="font-size: 23px;padding: 10px;">If desired peel off the skin. </li>
      <li style="font-size: 23px;padding: 10px;">Wash and peel oranges.Desired and halve them.</li>
      ...
      <li style="font-size: 23px;padding: 10px;">If making in juicer ,then cut to desired sizes to suit your juicer chute.</li>
      <h3>How to make Carrot juice</h3>
      <li style="font-size: 23px;padding: 10px;">Run the machine.</li>
      <li style="font-size: 23px;padding: 10px;">If making in  mixer or blender,the pass through a strainer/filter and collect the juice at the bottom.</li>
      <li style="font-size: 23px;padding: 10px;"> Serve carrot juice fresh and immediately.</li>
