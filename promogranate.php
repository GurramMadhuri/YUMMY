...
<div class="wrapper">
  <div class="img">
    <img src="./images/pome-background.jpg">
  </div>
  <div class="title">
  ...
  <div style="background-color:black" id="ingredients" class="tabcontent">
    ...
    <ul>
      <li style="font-size: 25px;padding: 20px;color: white">1 kg Pomegrantes</li>
      <li style="font-size: 25px;padding: 20px;color: white">1 medium Lemon</li>
      <li style="font-size: 25px;padding: 20px;color: white"><sup>1</sup>&frasl;<sub>8 </sub>teaspoon salt</li>
      <li style="font-size: 25px;padding: 20px;color: white">1<sup>1</sup>&frasl;<sub>2</sub>inch ginger</li>
      <li style="font-size: 25px;padding: 20px;color: white">1 <sup>1</sup>&frasl;<sub>4 </sub>tsp pepper corn</li>
  ...
  <div id="directions" class="tabcontent">
    ...
    <h4 style="font-size: 28px;">How to make deseed Pomegrante</h4>

    <ul>
      <li style="font-size: 23px;padding: 10px;"> Rinse the Pomegrantes under running water</li>
    <li style="font-size: 23px;padding: 10px;">Cut Off <sup>1</sup>&frasl;<sub>4 </sub>inch of the bottom of the pomegrante to stabalize it.</li>
    <li style="font-size: 23px;padding: 10px;">Remove the top of the pomegranate by cutting a shallow,angled circle around the crown.wiggle it loose and discard.</li>
    <li style="font-size: 23px;padding: 10px;">Make  shallow cuts on the sides,from the top of the fruit to the bottom,to divide the pomegrante into fout segments.</li>
    <li style="font-size: 23px;padding: 10px;">Pry open the segments to separate them.</li>
</ul>

    <h4 style="font-size: 28px;">How to make Pomegranate juice</h4>
<ul>
   <li style="font-size: 23px;padding: 20px;">Add the seeds to a blender jar along with salt.Squeeze the lemon juice into the blender.</li>
   <li style="font-size: 23px;padding: 20px;">Pulse a few items,briefly for 10 to 15 seconds,you want to make sure the seeds are still mostly intact but the juice around the seeds is released.Crushing the seeds will make the juice gritty.</li>
   <li style="font-size: 23px;padding: 20px;">But the seeds have medicinal values so we always crush them and pass through a very fine strainer.so it is up to you.</li>
    <li style="font-size: 23px;padding: 20px;">Place a fine fine mesh strainer over a large bowl and transfer the juice.
       It is important to use a fine strainer or a thin cheese cloth if you do not want the juice to be gritty.</li>
    <li style="font-size: 23px;padding: 20px;">Press the pulp aganist the strainer with the back of a spoon to squeeze out every bit of fresh juice.</li>
    <li style="font-size: 23px;padding: 20px;"> Drink your Pomegrante juice as is, store in the refrigerator for later culinary uses,or dilute with seltzer water to stretch the juice further.
      If it is too strong for your taste,you may mix it with other fruit juices or plain water.
  </li>
</ul>
  </div>
  <div id="time" class="tabcontent">
    ...
    <ul>
      <li style="font-size: 23px;padding: 20px;">10m preparation time</li>
      <li style="font-size: 23px;padding: 20px;">10m total</li>
    </ul>
  </div>
