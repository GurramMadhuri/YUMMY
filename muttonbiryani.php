...
<div class="wrapper">
  <div class="img">
    <img src="./images/muttonbiryani.jpg">
  </div>
  <div class="title">
  ...
  <div style="background-color:black" id="ingredients" class="tabcontent">
    ...
    <ul>
      <li style="font-size: 25px;padding: 20px;color: white">1 cup Oil/Ghee</li>
<li style="font-size: 25px;padding: 20px;color: white">2 Inches Cinnamon Stick</li>
<li style="font-size: 25px;padding: 20px;color: white">6 Cloves,
6 Cardamoms</li>
<li style="font-size: 25px;padding: 20px;color: white">1 tsp Black Cumin Seeds</li>
<li style="font-size: 25px;padding: 20px;color: white">1 Black Cardamom</li>
<li style="font-size: 25px;padding: 20px;color: white">1 Biryani leaf</li>
<li style="font-size: 25px;padding: 20px;color: white">1 cup Sliced Onions</li>
<li style="font-size: 25px;padding: 20px;color: white">6 Sliced Green Chillies</li>
<li style="font-size: 25px;padding: 20px;color: white">1 tsp Garam Masala
,Turmeric – Two pinches,
1/2 tsp Roasted Cumin Powder</li>
<li style="font-size: 25px;padding: 20px;color: white">Salt,
1.5 tbsp Ginger Garlic Paste</li>
<li style="font-size: 25px;padding: 20px;color: white">2 tbsp Dried Rose Petals/Rose Water (1 tsp)</li>
<li style="font-size: 25px;padding: 20px;color: white">1.5 cup Basmati Rice (Soaked for an hour - 250 gm)</li>
<li style="font-size: 25px;padding: 20px;color: white">300 gm Mutton (marinated for 2 hours in Salted Water)</li>
<li style="font-size: 25px;padding: 20px;color: white">1.5 cup Water to cook Mutton,1 cup Water to cook Pulao</li>
  ...
  <div id="directions" class="tabcontent">
    ...
    <ul>
      <li style="font-size: 23px;padding: 10px;">Heat Oil in a Cooker, add Cinnamon, Cloves, Black Cumin, Cardamoms, Black Cardamoms and Cumin Seeds and roast.</li>
<li style="font-size: 23px;padding: 10px;">Add Onions and Green Chillies and fry till golden.</li>
<li style="font-size: 23px;padding: 10px;">While the Onions are getting cooked, add Ginger Garlic Paste and fry.</li>

 
<li style="font-size: 23px;padding: 10px;">Add Mutton and fry for 4-5 minutes. Add Mirchi Powder, Cumin Seeds Powder, Salt, Turmeric and enough Water to cook and let the Mutton cook until soft.</li>
<li style="font-size: 23px;padding: 10px;">After the Mutton is cooked, there would still be a Cup of Water. </li>
  <li style="font-size: 23px;padding: 10px;">Add soaked Rice, Salt and less than a cup of Water, dried Rose Petals and cover the cooker. Cook on a medium flame to one whistle. </li>
    <li style="font-size: 23px;padding: 10px;">Switch off the stove and let it rest for 20 minutes.</li>
      <li style="font-size: 23px;padding: 10px;">
After 20 minutes, turn the Rice over with a flat ladle from the bottom and serve with Mirchi Ka Salan and Raitha.</li>
