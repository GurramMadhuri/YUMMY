...
<div class="wrapper">
  ...
  <div style="background-color:black" id="ingredients" class="tabcontent">
    ...
    <ul>
      <li style="font-size: 25px;padding: 20px;color: white">250 gms Rice,1/2 cup Oil,4 Sprigs Curry Leaves</li>
      <li style="font-size: 25px;padding: 20px;color: white">3 Green Chillies,1 tsp Turmeric,Salt</li>
      <li style="font-size: 25px;padding: 20px;color: white">50 gms Tamarind</li>
      <li style="font-size: 25px;padding: 20px;color: white">1 tsp Mustard Seeds</li>
      <li style="font-size: 25px;padding: 20px;color: white">1 tsp Fenugreek Seeds</li>
      <li style="font-size: 25px;padding: 20px;color: white">1/2 tsp Asafoetida</li>
      <li style="font-size: 25px;padding: 20px;color: white">1/4 cup Groundnuts</li>
      <li style="font-size: 25px;padding: 20px;color: white">1 tbsp Bengal Gram</li>
      <li style="font-size: 25px;padding: 20px;color: white">1 tbsp Black Gram</li>
      <li style="font-size: 25px;padding: 20px;color: white">6 Red Chillies,1 inch Ginger
  ...
  <div id="directions" class="tabcontent">
    ...
    <ul>
      <li style="font-size: 23px;padding: 10px;">Soak Tamarind in hot water and extract 250ml of Tamarind juice.</li>
<li style="font-size: 23px;padding: 10px;">Wash rice and cook with two cups of water per cup of rice on three whistles.</li>
<li style="font-size: 23px;padding: 10px;">When the steam goes out of the rice, add Turmeric, Oil, Green Chillies, Curry Leaves and Salt while the rice is still hot.</li>
      <li style="font-size: 23px;padding: 10px;"> Grind Mustard Seeds, Red Chillies, Ginger and a little salt to a soft paste. (Before you grind, check out the tips).</li>

<li style="font-size: 23px;padding: 10px;">Heat 2 tsp of Oil and roast Mustard Seeds and Fenugreek Seeds. Add curry leaves.</li>
<li style="font-size: 23px;padding: 10px;">Pour the Tamarind Extract and add grated Jaggery and cook until it becomes a thick paste.</li>
      <li style="font-size: 23px;padding: 10px;"> 
Once it is thick, add the Mustard Seeds paste and let it cook. After it is thoroughly cooked, switch off the stove, let it cool completely and then mix it well in the rice.</li>
<li style="font-size: 23px;padding: 10px;">For the second seasoning, heat ¼ cup Oil, add mustard and let them crackle. Then add Groundnuts, Bengal Gram and Black Gram and roast them.</li>
<li style="font-size: 23px;padding: 10px;">Add Red Chillies and Curry Leaves and fry them and add to the Rice. And your Prasadam Pulihora is ready.
</li>
</ul>
