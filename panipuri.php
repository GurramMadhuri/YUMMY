...
<div class="wrapper">
  ...
  <div id="ingredients" class="tabcontent">
          ...
          <ul>
    <li style="font-size: 23px;padding: 10px;">3 cup rava / semolina / suji (coarse)</li>
    <li style="font-size: 23px;padding: 10px;"> 6 tbsp maida / plain flour</li>
     <li style="font-size: 23px;padding: 10px;">9 tbsp oil</li>
    <li style="font-size: 23px;padding: 10px;">0.75 cup hot water</li>
     <li style="font-size: 23px;padding: 10px;">oil (for frying)</li>
    <h4 style="color: orange;font-size: 40px;">For theeka pani:</h4>
     <li style="font-size: 23px;padding: 10px;">0.75 cup mint / pudina</li>
    <li style="font-size: 23px;padding: 10px;">1.5 cup coriander</li>
    <li style="font-size: 23px;padding: 10px;">3 inch ginger</li>
     <li style="font-size: 23px;padding: 10px;">6 chilli</li>
<li style="font-size: 23px;padding: 10px;">small ball sized tamarind</li>
<li style="font-size: 23px;padding: 10px;">3 cup rava / semolina / suji (coarse)</li>
<li style="font-size: 23px;padding: 10px;">6 tbsp maida / plain flour</li>
<li style="font-size: 23px;padding: 10px;">9 tbsp oil</li>
<li style="font-size: 23px;padding: 10px;">0.75 cup hot water</li>
<li style="font-size: 23px;padding: 10px;">oil (for frying)</li>
<li style="font-size: 23px;padding: 10px;">3 tsp chaat masala</li>
<li style="font-size: 23px;padding: 10px;">3 tsp cumin powder</li>
<li style="font-size: 23px;padding: 10px;">pinch hing / asafoetida</li>
<li style="font-size: 23px;padding: 10px;">2.25 tsp salt</li>
<li style="font-size: 23px;padding: 10px;">12 cup cold water</li>
<h4 style="color: orange;font-size: 40px;">For khatta meetha pani:</h4>
<li style="font-size: 23px;padding: 10px;">3 cup tamarind extract</li>
<li style="font-size: 23px;padding: 10px;">9 tbsp jaggery / gud</li>
<li style="font-size: 23px;padding: 10px;">3 tsp chaat masala</li>
<li style="font-size: 23px;padding: 10px;">3 tsp cumin powder</li>
<li style="font-size: 23px;padding: 10px;">0.75 tsp pepper powder</li>
<li style="font-size: 23px;padding: 10px;">0.75 tsp kashmiri red chilli powder</li>
<li style="font-size: 23px;padding: 10px;">pinch hing / asafoetida</li>
<li style="font-size: 23px;padding: 10px;">2.25 tsp salt</li>
<li style="font-size: 23px;padding: 10px;">9 cup cold water</li>
<h4 style="color: orange;font-size: 40px;">For aloo stuffing:</h4>
<li style="font-size: 23px;padding: 10px;">9 potato / aloo (boiled & mashed)</li>
<li style="font-size: 23px;padding: 10px;">1.5 onion (finely chopped)</li>
<li style="font-size: 23px;padding: 10px;">6 tbsp coriander (finely chopepd)</li>
<li style="font-size: 23px;padding: 10px;">1.5 tsp cumin powder</li>
<li style="font-size: 23px;padding: 10px;">1.5 tsp chaat masala</li>
<li style="font-size: 23px;padding: 10px;">0.75 tsp pepper powder</li>
<li style="font-size: 23px;padding: 10px;">1.5 tsp kashmiri red chilli powder</li>
<li style="font-size: 23px;padding: 10px;">1.5 tsp salt</li>
<h4 style="color: orange;font-size: 40px;">For serving:</h4>
<li style="font-size: 23px;padding: 10px;">6 tbsp boondi</li>
        ...
        <div id="directions" class="tabcontent">
          ...
          <h4 style="color: orange;font-size: 40px;">Puri Recipe for pani puri</h4>
    <li style="font-size: 23px;padding: 10px;">Firstly, in a large bowl take 1 cup rava and 2 tbsp maida.</li>
    <li style="font-size: 23px;padding: 10px;">Add 3 tbsp oil, crumble and mix well making sure the rava turns moist.</li>
    <li style="font-size: 23px;padding: 10px;">Now add ¼ cup hot water and start to knead.</li>
    <li style="font-size: 23px;padding: 10px;">Knead for 5 to 8 minutes or until the dough is formed.
    <li style="font-size: 23px;padding: 10px;">Sprinkle water as required and knead to a smooth and soft dough.</li>
    <li style="font-size: 23px;padding: 10px;">Cover the dough and rest for 20 minutes.</li>
    <li style="font-size: 23px;padding: 10px;">After 20 minutes, continue to knead for 2 more minutes.</li>
    <li style="font-size: 23px;padding: 10px;">Now pinch a very small ball sized dough.</li>
     <li style="font-size: 23px;padding: 10px;">Roll and flatten into small disk making sure it is thin.</li>
     <li style="font-size: 23px;padding: 10px;">Deep fry in hot oil, do not overcrowd the oil.</li>
     <li style="font-size: 23px;padding: 10px;">Flip over once the puri puffs up.</li>
      <li style="font-size: 23px;padding: 10px;">Fry on medium flame until it turns golden brown and crisp from both the sides.</li>
     <li style="font-size: 23px;padding: 10px;">Drain off over kitchen paper to get rid off excess oil.</li>
     <li style="font-size: 23px;padding: 10px;">Puri is ready for pani puri. once cooled completely, you can store in an airtight container and use it for a week</li>
     <h4 style="color: orange;font-size: 40px;">Theeka pani preparation</h4>
     <li style="font-size: 23px;padding: 10px;">Firstly, in a small blender take ¼ cup mint, ½ cup coriander, 1 inch ginger, 2 chilli and small ball sized tamarind.</li>
    <li style="font-size: 23px;padding: 10px;">Blend to smooth paste adding water as required.</li>
    <li style="font-size: 23px;padding: 10px;">Transfer theeka pani puri paste into a large bowl.</li>
   <li style="font-size: 23px;padding: 10px;">Add 1 tsp chaat masala, 1 tsp cumin powder, pinch hing, ¾ tsp salt and 4 cup cold water.</li>
   <li style="font-size: 23px;padding: 10px;">Mix well and theeka pani is ready to enjoy with golgappa.</li>
  <h4 style="color: orange;font-size: 40px;">For khatta meetha pani preparation</h4>
   <li style="font-size: 23px;padding: 10px;">Firstly, in a large bowl take 1 cup tamarind extract and 3 tbsp jaggery.</li>
   <li style="font-size: 23px;padding: 10px;">Also add 1 tsp chaat masala, 1 tsp cumin powder, ¼ tsp pepper powder, ¼ tsp chilli powder, pinch hing, ¾ tsp salt and 3 cup cold water.</li>
   <li style="font-size: 23px;padding: 10px;">Mix well and khatta meetha pani is ready to enjoy with golgappa.</li>
   <h4>Aloo stuffing preparation</h4>
   <li style="font-size: 23px;padding: 10px;">Firstly, in a small bowl take 3 potato, ½ onion and 2 tbsp coriander.</li>
   <li style="font-size: 23px;padding: 10px;">Also add ½ tsp cumin powder, ½ tsp chaat masala, ¼ tsp pepper powder, ½ tsp chilli powder and ½ tsp salt.</li>
   <li style="font-size: 23px;padding: 10px;">Mix well making sure everything is well combined.</li>
   <li style="font-size: 23px;padding: 10px;">Aloo stuffing is ready to enjoy with puchka.</li>
   <h4 style="color: orange;font-size: 40px;">Assembling pani puri for serving</h4>
   <li style="font-size: 23px;padding: 10px;">Firstly, just before serving add handful of boondi to theeka pani and khatta meetha pani.</li>
   <li style="font-size: 23px;padding: 10px;">Make a small hole in centre of puri.</li>
   <li style="font-size: 23px;padding: 10px;">Stuff a tsp of prepared aloo stuffing into puri.</li>
  <li style="font-size: 23px;padding: 10px;">Dip into theeka pani or khatta meetha pani and enjoy.</li>
   <li style="font-size: 23px;padding: 10px;">Finally, pani puri recipe is ready to serve.</li>
</div>
