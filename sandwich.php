...
<div class="wrapper">
  <div class="img">
        <img src="./images/veg_sandwich.jpg">
  ...
  <div id="ingredients" class="tabcontent">
          ...
          <ul>
      <li style="font-size: 23px;padding: 10px;">12 bread slices (brown / white bread)</li>
      <li style="font-size: 23px;padding: 10px;">6 tsp oil</li>
  <li style="font-size: 23px;padding: 10px;">1.5 onion (finely chopped)</li>
  <li style="font-size: 23px;padding: 10px;">1.5 cup corn (fresh / frozen)</li>
  <li style="font-size: 23px;padding: 10px;">3 carrot (finely chopped)</li>
  <li style="font-size: 23px;padding: 10px;">1.5 capsicum (finely chopped)</li>
  <li style="font-size: 23px;padding: 10px;">3 bunch spinach / palak leaves (chopped)</li>
  <li style="font-size: 23px;padding: 10px;">3 tsp crushed pepper</li>
  <li style="font-size: 23px;padding: 10px;">1.5 tsp mixed herbs (optional)</li>
  <li style="font-size: 23px;padding: 10px;">salt to taste</li>
  <li style="font-size: 23px;padding: 10px;">6 tbsp tomato sauce</li>
  <li style="font-size: 23px;padding: 10px;">6 tbsp green chutney</li>
  <li style="font-size: 23px;padding: 10px;">0.75 cup mozzarella or cheddar cheese (grated)</li>
  <li style="font-size: 23px;padding: 10px;">6 tsp butter</li>
        ...
        <div id="directions" class="tabcontent">
          ...
          <ul>
          <li style="font-size: 23px;padding: 10px;">Firstly, in a large kadai heat oil and fry onions.</li>
   <li style="font-size: 23px;padding: 10px;">Further add corn, carrot and capsicum. fry for a minute till the veggies are half cooked yet crunchy.</li>
   <li style="font-size: 23px;padding: 10px;">Now add chopped spinach and fry till they shrink in size.</li>
   <li style="font-size: 23px;padding: 10px;">Also add pepper, mixed herbs and salt. give a good mix.</li>
   <li style="font-size: 23px;padding: 10px;">Now take 2 breads and on one spread tomato sauce and green chutney on the other.</li>
   <li style="font-size: 23px;padding: 10px;">Also place the prepared stuffing and spread uniformly on the bread slice.</li>
   <li style="font-size: 23px;padding: 10px;">Further, grate the cheese over the stuffing.</li>
   <li style="font-size: 23px;padding: 10px;">Cover with the other slice of bread and grill or toast on tawa.</li>
   <li style="font-size: 23px;padding: 10px;">Spread butter on both the outer sides of bread to make sandwich more crispy and golden.</li>
   <li style="font-size: 23px;padding: 10px;">Furthermore, close the griller and grill till the cheese melts and bread turn golden brown.</li>
   <li style="font-size: 23px;padding: 10px;">Now cut the bread into half and serve.</li>
