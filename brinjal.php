...
<div class="wrapper">
  ...
  <div style="background-color:black" id="ingredients" class="tabcontent">
    ...
    <ul>
      <li style="font-size: 25px;padding: 20px;color: white">1/2 cup Oil,1 cup Chopped Onions,1 tbsp Bengal Gram</li>
      <li style="font-size: 25px;padding: 20px;color: white">Salt,1/4 cup Cumin,2 Green Chilli</li>
      <li style="font-size: 25px;padding: 20px;color: white">2 Tomato,2 Turmeric,1/4 cup Grated Coconut</li>
      <li style="font-size: 25px;padding: 20px;color: white">1 cup Water,1 tsp Mustard</li>
      <li style="font-size: 25px;padding: 20px;color: white">2 Sprigs Curry Leaves,10 Garlic,1 tsp Pepper</li>
      <li style="font-size: 25px;padding: 20px;color: white">2 tsp Chilli powder</li>
      <li style="font-size: 25px;padding: 20px;color: white">2 tbsp Coriander powder</li>
      <li style="font-size: 25px;padding: 20px;color: white">10 - 12 Brinjal</li>
      <li style="font-size: 25px;padding: 20px;color: white">1/3 cup Tamarind (Extracted from 70 gms of Tamarind)</li>
      <li style="font-size: 25px;padding: 20px;color: white">1/4 cup Green Coriander</li>
  ...
  <div id="directions" class="tabcontent">
    ...
    <ul>
      <li style="font-size: 23px;padding: 10px;">Heat the Oil. Fry all the ingredients used for Masala Paste one after the other, add Tomatoes and cook till the tomatoes become soft.</li>

     <li style="font-size: 23px;padding: 10px;">Grind it along with Coconut pieces to make the Masala Paste (can use Coconut Oil to get an authentic taste).</li>
    <li style="font-size: 23px;padding: 10px;">Heat some oil in a pan and fry Mustard, Cumin, Red Chillies, Curry Leaves, Garlic, Pepper and chopped Onions.</li>
    <li style="font-size: 23px;padding: 10px;"> Once the Onions turn golden brown, add slit Brinjals, Salt and cover with a lid. Cook till the Brinjals become soft.</li>
    <li style="font-size: 23px;padding: 10px;">Now add Chilli powder, Coriander powder and saute for some time. Add Tamarind pulp and mix well. Cook it till the Oil separates from the Gravy.</li>
    <li style="font-size: 23px;padding: 10px;">Add Masala Paste, sufficient Water and cook on a low flame till the Oil gets separated from the Gravy.</li>

 
<li style="font-size: 23px;padding: 10px;">Finally, add chopped coriander and remove it from the fire. This Curry goes well with hot Rice.</li>
