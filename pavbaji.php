...
<div class="wrapper">
  <div class="img">
        <img src="./images/Pav-Bhaji-Recipe.jpg">
  ...
  <div id="ingredients" class="tabcontent">
          ...
          <ul>
      <li style="font-size: 23px;padding: 10px;">3 tbsp + 1 tbsp butter</li>
      <li style="font-size: 23px;padding: 10px;">9 to mato (finely chopped)</li>
      <li style="font-size: 23px;padding: 10px;">0.75 cup peas / matar</li>
      <li style="font-size: 23px;padding: 10px;">1.5 capsicum (finely chopped)</li>
      <li style="font-size: 23px;padding: 10px;">6 potato (boiled & mashed)</li>
      <li style="font-size: 23px;padding: 10px;">3 tsp salt</li>
      <li style="font-size: 23px;padding: 10px;">3 tsp + ¼ tsp kashmiri red chilli powder / lal mirch powder</li>
      <li style="font-size: 23px;padding: 10px;">0.75 tsp turmeric / haldi</li>
      <li style="font-size: 23px;padding: 10px;">3 tsp + ½ tsp pav bhaji masala</li>
      <li style="font-size: 23px;padding: 10px;">3 tsp + 1 tsp kasuri methi / dry fenugreek leaves</li>
      <li style="font-size: 23px;padding: 10px;">6 tbsp + 1 tbsp coriander leaves (finely chop ped)</li>
      <li style="font-size: 23px;padding: 10px;">3 tsp ginger garlic paste</li>
      <li style="font-size: 23px;padding: 10px;">3 onion (finely chopped)</li>
      <li style="font-size: 23px;padding: 10px;">1.5 lemon juice</li>
      <li style="font-size: 23px;padding: 10px;">9 drops red food colour (optional)</li>
      <li style="font-size: 23px;padding: 10px;">water to adjust consistency</li>
      <h4>To toast pav:</h4>
      <li style="font-size: 23px;padding: 10px;">24 pav / bread roll</li>
      <li style="font-size: 23px;padding: 10px;">12 tsp butter</li>
      <li style="font-size: 23px;padding: 10px;">1.5 tsp kashmiri red chilli powder / lal mirch powder</li>
      <li style="font-size: 23px;padding: 10px;">1.5 tsp pav bhaji masala</li>
      <li style="font-size: 23px;padding: 10px;">12 tsp coriander leaves (finely chopped)</li>

    </ul>        </div>
        <div id="directions" class="tabcontent">
          <h3 style="color: orange;font-size: 40px;">DIRECTIONS</h3>
          <ul>
          <li style="font-size: 23px;padding: 10px;">Firstly, in a large kadai heat 1 tbsp butter and add vegetables. cook and mash well.</li>
    <li style="font-size: 23px;padding: 10px;">Now add 1 tsp chilli powder, ¼ tsp turmeric, 1 tsp pav bhaji masala, 1 tsp kasuri methi and 2 tbsp coriander leaves.</li>
   <li style="font-size: 23px;padding: 10px;">Heat a tbsp of butter and add ¼ tsp chilli powder, ½ tsp pav bhaji masala, 1 tsp kasuri methi.</li>
    <li style="font-size: 23px;padding: 10px;">Also add 1 tbsp coriander leaves, 1 tsp ginger garlic paste, 1 onion and ½ lemon juice. saute well.</li>
    <li style="font-size: 23px;padding: 10px;">Now add 3 drops of red food colour and mix well.</li>
    <li style="font-size: 23px;padding: 10px;">Boil and mash for 5 minutes adjusting consistency.</li>
     <li style="font-size: 23px;padding: 10px;">Finally, serve pav and bhaji as pav bhaji.</li>
   </ul>
</div>
