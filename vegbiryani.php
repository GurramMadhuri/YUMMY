...
<div class="wrapper">
  ...
  <div style="background-color:black" id="ingredients" class="tabcontent">
    ...
    <ul>
      <li style="font-size: 25px;padding: 20px;color: white">1 cup Basmati Rice (Soaked for an hour)</li>
      <li style="font-size: 25px;padding: 20px;color: white">1/2 cup Ghee,Onions – Chopped Medium size,3 Sliced Green Chillies</li>
      <li style="font-size: 25px;padding: 20px;color: white">2 Ripe Tomatoes,1/2 bunch Mint leaves</li>
      <li style="font-size: 25px;padding: 20px;color: white">1/2 bunch Coriander Leaves,1/2 cup Curd,4 Cardamoms</li>
      <li style="font-size: 25px;padding: 20px;color: white">4 Cloves,1 Inch Cinnamon Stick,1 Star Anise</li>
      <li style="font-size: 25px;padding: 20px;color: white">Nutmeg – Tiny piece,1 Biryani leaf,1 tsp Cumin Seeds</li>
      <li style="font-size: 25px;padding: 20px;color: white">1 tsp Saunf/Fennel Seeds,Salt,1 tsp Ginger Garlic Paste,1/4 spoon Turmeric</li>
      <li style="font-size: 25px;padding: 20px;color: white">1 tsp Mirchi Powder</li>
      <li style="font-size: 25px;padding: 20px;color: white">1/2 tsp Garam Masala</li>
      <li style="font-size: 25px;padding: 20px;color: white">1 cup Water</li>
  ...
  <div id="directions" class="tabcontent">
    ...
    <ul>
      <li style="font-size: 23px;padding: 10px;">Melt Ghee in a pressure cooker and add Cardamoms, Cloves, Cinnamon, Star Anise, Nutmeg and Biryani Leaf and fry.</li>
     <li style="font-size: 23px;padding: 10px;">Add Cumin Seeds and Saunf. Then add Onions and Green Chillies and fry well.</li>
     <li style="font-size: 23px;padding: 10px;">Fry Ginger Garlic paste and add diced ripe Tomatoes, Turmeric, Salt, Mirchi Powder, Garam Masala and cook slowly until the Tomatoes turn into a pulp.</li>

      <li style="font-size: 23px;padding: 10px;">Add ½ Cup non-sour whisked Curds and mix well and cook until the Ghee comes to the surface.</li>

      <li style="font-size: 23px;padding: 10px;">When the Ghee comes to the surface, add Coriander and Mint leaves and mix well.</li>
      <li style="font-size: 23px;padding: 10px;"> Then add the Basmati Rice, soaked for an hour in Water, and blend on high flame for a minute, taking care to see that the grain does not break.</li>
      <li style="font-size: 23px;padding: 10px;">Add one cup of water, let the Rice cook on high flame till one whistle, switch off and leave it for 20 minutes.</li>

      <li style="font-size: 23px;padding: 10px;"> After 20 minutes, take the lid off and turn over the Rice from the bottom with a flat spoon. And fragrant Khuska is ready.</li>
      <li style="font-size: 23px;padding: 10px;">Khuska can be eaten with Raita, Masala Curry or with any non-veg Curry.</li>
