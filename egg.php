...
<div class="wrapper">
  <div class="img">
    <img src="./images/eggmasalafry.jpg">
  </div>
  <div class="title">
    <h4>EGG MASALA FRY</h4>
  </div>
  <ul class="tab">
...
<div style="background-color:black" id="ingredients" class="tabcontent">
  ...
  <ul>
    <li style="font-size: 25px;padding: 20px;color: white">4 Boiled Eggs</li>
<li style="font-size: 25px;padding: 20px;color: white">3 Onions (Thinly sliced)</li>
<li style="font-size: 25px;padding: 20px;color: white">4 Green Chillies Sliced
,Salt</li>
<li style="font-size: 25px;padding: 20px;color: white">1 tbsp Mirchi Powder
,1/4 tsp Turmeric</li>
<li style="font-size: 25px;padding: 20px;color: white">Mint – A little
Green Coriander – A little</li>
<li style="font-size: 25px;padding: 20px;color: white">4 tbsp Oil,2 tbsp Coriander Seeds</li>
<li style="font-size: 25px;padding: 20px;color: white">2 tsp Poppy Seeds
,1/4 cup Dry Coconut</li>
<li style="font-size: 25px;padding: 20px;color: white">1 Star Anise
,1 inch Cinnamon Sticks</li>
<li style="font-size: 25px;padding: 20px;color: white">3 Cardamoms,4 Cloves</li>
...
<li style="font-size: 23px;padding: 10px;">Roast all spices on a low flame until they give out a nice aroma.</li>
<li style="font-size: 23px;padding: 10px;">Make a Powder of all the roasted spices.Heat oil and add the boiled Eggs. Cover and fry until they turn golden.</li>

 
<li style="font-size: 23px;padding: 10px;">In the same Oil, add Onions, Green Chillies and Salt and cook until the onions soften.</li>
<li style="font-size: 23px;padding: 10px;">Add Turmeric, Mirchi and Ginger Garlic Paste and fry for 2 minutes.</li>
<li style="font-size: 23px;padding: 10px;">Cut the boiled Eggs into inch-long pieces and add them to the Curry. Add the spice Powder too and cook for 2 minutes.</li>
<li style="font-size: 23px;padding: 10px;"> Sprinkle Green Coriander and Mint leaves and mix well and remove from fire.</li>
