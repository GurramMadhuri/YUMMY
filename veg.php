...
<!-- Navbar ends -->
 ...
 <section style="padding: 20px;" class="popular" id="popular">
      ...
      <h1 class="heading"> VEG RECIPES </h1>

      <div class="box-container">

          <div class="box">

              <img src="./images/pannercurry.jpg" alt="">
              <h3>PANEER CURRY</h3>
              <a href="panner.php" class="btn">View More</a>
          </div>
          <div class="box">

              <img src="./images/pulihora.jpg" alt="">
              <h3>PULIHORA</h3>
              <a href="pulihora.php" class="btn">View More</a>
          </div>
          <div class="box">

              <img src="./images/mushroom.jpg" alt="">
              <h3>MUSHROOM</h3>
              <a href="mushroom.php" class="btn">View More</a>
          </div>
          <div class="box">

              <img src="./images/vegbiryani.jpg" alt="">
              <h3>VEG BIRYANI</h3>
              <a href="vegbiryani.php" class="btn">View More</a>
          </div>
          <div class="box">

              <img src="./images/brinjal.jpg" alt="">
              <h3>BRINJAL</h3>
              <a href="brinjal.php" class="btn">View More</a>
          </div>
          <div class="box">

              <img src="./images/vegfriedrice.jpg" alt="">
              <h3>VEG FRIED RICE</h3>
              <a href="vegfriedrice.php" class="btn">View More</a>
          </div>
