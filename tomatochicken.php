...
<div class="wrapper">
  <div class="img">
    <img src="./images/chickencurry.jpg">
  </div>
  <div class="title">
    <h4>TOMATO CHICKEN</h4>
  </div>
  <ul class="tab">
...
<div style="background-color:black" id="ingredients" class="tabcontent">
  ...
  <ul>
    <li style="font-size: 25px;padding: 20px;color: white">500 gms Chicken (Soaked for 30 minutes in Salt water)</li>
<li style="font-size: 25px;padding: 20px;color: white">1/2 kilo Country Tomatoes</li>
<li style="font-size: 25px;padding: 20px;color: white">150 gms Chopped Onions</li>
<li style="font-size: 25px;padding: 20px;color: white">3 Green Chillies slit</li>
<li style="font-size: 25px;padding: 20px;color: white">1 Sprig Curry Leaves
,2 tsp Green Coriander chopped</li>
<li style="font-size: 25px;padding: 20px;color: white">1/2 tsp Mustard Seeds
,1/2 tsp Cumin Seeds</li>
<li style="font-size: 25px;padding: 20px;color: white">2 -3 Red Chillies,Salt,1/2 tsp Turmeric</li>
<li style="font-size: 25px;padding: 20px;color: white">2 tsp Red Chilli Powder,1 tsp Garam Masala</li>
<li style="font-size: 25px;padding: 20px;color: white">1.25 tbsp Ginger Garlic ,Paste,1/3 cup Oil</li>
  ...
  <div id="directions" class="tabcontent">
    ...
    <ul>
      <li style="font-size: 23px;padding: 10px;">Heat Oil and add big pieces of 2 ripe Tomatoes. Fry for 3 minutes and set aside.</li>
      <li style="font-size: 23px;padding: 10px;">In the same oil, add Mustard Seeds, Cumin Seeds, Red Chillies, and roast. Then add the chopped Onions and fry well until they turn light golden.</li>
      <li style="font-size: 23px;padding: 10px;"> Then add the Ginger Garlic Paste and fry for a minute.</li>
      <li style="font-size: 23px;padding: 10px;">Now add the paste of the remaining Tomatoes and fry until the raw taste disappears and the Tomatoes are well cooked. This takes time.</li>

 
    <li style="font-size: 23px;padding: 10px;">Then add Green Chillies, Salt, Mirchi Powder, Garam Masala, and Turmeric and mix well.</li>
    <li style="font-size: 23px;padding: 10px;">Then add chicken, mix well and fry on a high flame for 4 minutes.</li>
    <li style="font-size: 23px;padding: 10px;">Once the Chicken loses its water and becomes dry, pour 1/4th liter of Water and cook while stirring now and then.</li>

 
    <li style="font-size: 23px;padding: 10px;">After the Curry is cooked more than half, add the Tomato pieces that were fried and set aside. Add the Curry Leaves and fry till the oil separates.</li>

    <li style="font-size: 23px;padding: 10px;">Once Oil comes to the surface, sprinkle Green Coriander and remove it from the fire.</li>
