...
<div class="wrapper">
  <div class="img">
    <img src="./images/paneer_butter_masala.jpg">
  </div>
  <div class="title">
    <h4>PANEER CURRY</h4>
  </div>
  ...
  <div style="background-color:black" id="ingredients" class="tabcontent">
    ...
    <ul>
      <li style="font-size: 25px;padding: 20px;color: white">200 gms Paneer</li>
      <li style="font-size: 25px;padding: 20px;color: white">5 Tomatoes,1 Onion</li>
      <li style="font-size: 25px;padding: 20px;color: white">1/4 cup Cashew Nuts,1 Inch Cinnamon Stick</li>
      <li style="font-size: 25px;padding: 20px;color: white">2 Cardamoms,2 Cloves,1/2 Ginger Piece</li>
      <li style="font-size: 25px;padding: 20px;color: white">4 Garlic Cloves,1/2 tsp Crushed Kasuri Methi</li>
      <li style="font-size: 25px;padding: 20px;color: white">3/4 tsp Coriander Powder,3/4 tsp Roasted Cumin Powder</li>
      <li style="font-size: 25px;padding: 20px;color: white">1 tsp Sugar,4 tbsps Butter,Salt</li>
      <li style="font-size: 25px;padding: 20px;color: white">2 tsps Kashmir Mirchi Powder,1 tbsp Oil</li>
      <li style="font-size: 25px;padding: 20px;color: white">1/2 cup Fresh Cream (Milk Cream),2 tsps Fresh Green Coriander</li>
      <li style="font-size: 25px;padding: 20px;color: white">300 ml Water for Gravy,1/2 ltr Water to cook Tomatoes
</li>
  ...
  <div id="directions" class="tabcontent">
    ...
    <ul>
      <li style="font-size: 23px;padding: 10px;">Cook diced Tomatoes, Onions, Cinnamon, Cloves, Cardamoms, Cashew Nuts in a pan in half a liter of water.</li>
      <li style="font-size: 23px;padding: 10px;">When it is cooked well, grind it to a soft, smooth paste-like Butter in a mixie.</li>
      <li style="font-size: 23px;padding: 10px;"> Melt Butter in a pan, add some Oil and Kashmiri Mirchi Powder, fry a little, then add the Tomato Cashew Paste and let it cook until it becomes thick.</li>
    
    <li style="font-size: 23px;padding: 10px;">Once the Gravy is thick, add Kasuri Methi Powder, Cumin Powder, Coriander Powder, Salt, Sugar and add 300ml of water.</li> 
    <li style="font-size: 23px;padding: 10px;">Let it boil.A frothy layer forms on the surface of the boiling Gravy.</li> 
    <li style="font-size: 23px;padding: 10px;">Remove it so that the Curry looks attractive.When the Gravy is thick, add the Paneer pieces and let it cook for 2-3 minutes.</li>
    
    <li style="font-size: 23px;padding: 10px;">Finally, add Fresh Cream (Milk Cream) and mix.Sprinkle chopped Green Coriander before removing from fire.
</li>
</ul>
