...
<div class="wrapper">
  <div class="img">
    <img src="./images/chickenbiryani.jpg">
  </div>
  <div class="title">
  ...
  <div style="background-color:black" id="ingredients" class="tabcontent">
    ...
    <ul>
     ...
     <li style="font-size: 25px;padding: 20px;color: white">250 gms Basmati Rice (1.5 cup)</li>
     <li style="font-size: 25px;padding: 20px;color: white">1/4 cup Curd,1 Onion,1 Tomato</li>
    <li style="font-size: 25px;padding: 20px;color: white">2 tsp Chopped Mint leaves</li>
    <li style="font-size: 25px;padding: 20px;color: white">2 tsp Chopped Coriander Leaves</li>
    <li style="font-size: 25px;padding: 20px;color: white">1 tsp Mirchi Powder,Salt</li>
    <li style="font-size: 25px;padding: 20px;color: white">1/2 tsp Turmeric</li>
    <li style="font-size: 25px;padding: 20px;color: white">1 tbsp Ginger Garlic Paste,5 Cloves,4 Cardamoms</li>
   <li style="font-size: 25px;padding: 20px;color: white">1 inch Cinnamon,1,Biryani leaf</li>
   <li style="font-size: 25px;padding: 20px;color: white">1 tsp Black Cumin Seeds</li>
   <li style="font-size: 25px;padding: 20px;color: white">1/2 tsp Garam Masala</li>
  <li style="font-size: 25px;padding: 20px;color: white">1 tsp Coriander Powder</li>
   <li style="font-size: 25px;padding: 20px;color: white">1 tsp Roasted Cumin Powder</li>
   <li style="font-size: 25px;padding: 20px;color: white">2 1/4 cups Water,1/2 cup Oil</li>
 </ul>
  </div>
  ...
  <div id="directions" class="tabcontent">
    ...
    <ul>
      <li style="font-size: 23px;padding: 10px;">Heat Oil in a Cooker and add Cloves, Cinnamon, Cardamoms, Black Cumin Seeds, Biryani Leaf and fry until they give out a nice aroma.</li>
       <li style="font-size: 23px;padding: 10px;">Add sliced onion and fry till the color changes to golden brown.</li>
       <li style="font-size: 23px;padding: 10px;">When you get a good color, add Ginger Garlic Paste, Turmeric, Mirchi Powder, Coriander Powder, Cumin Powder and Garam Masala and fry.</li>

 
         <li style="font-size: 23px;padding: 10px;">Add diced tomatoes and let them cook until soft.</li>
        <li style="font-size: 23px;padding: 10px;">Take the Chicken soaked in saltwater for an hour, add it to the spices and fry on high flame for 4-5 minutes.</li>
         <li style="font-size: 23px;padding: 10px;"> Add 2 cups of water.Take the soaked Basmati Rice, mix well. Add whisked Curd, Chopped Mint leaves, Chopped Green Coriander.</li>
          <li style="font-size: 23px;padding: 10px;"> Mix and cook in the pressure cooker on high flame to two whistles. Then switch it off and leave it for 30 minutes.</li>

           <li style="font-size: 23px;padding: 10px;">After 30 minutes, turn it over from the bottom with a flat spoon. There is your Perfect Chicken Pulao.</li>
  ...
  <div id="time" class="tabcontent">
    ...
    <ul>
      <li style="font-size: 23px;padding: 20px;">30m preparation time</li>
    </ul>
  </div>
