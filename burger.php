...
<div class="wrapper">
  ...
  <div id="ingredients" class="tabcontent">
          ...
          <ul>
      <li style="font-size: 23px;padding: 10px;">1.5 carrot (finely chopped)</li>
<li style="font-size: 23px;padding: 10px;">12 beans (finely chopped)</li>
<li style="font-size: 23px;padding: 10px;">6 tbsp sweet corn</li>
<li style="font-size: 23px;padding: 10px;">6 tbsp peas / matar</li>
<li style="font-size: 23px;padding: 10px;">0.75 tsp salt</li>
<li style="font-size: 23px;padding: 10px;">9 potato / aloo (boiled & grated)</li>
<li style="font-size: 23px;padding: 10px;">0.75 tsp cumin powder</li>
<li style="font-size: 23px;padding: 10px;">1.5 tsp garam masala</li>
<li style="font-size: 23px;padding: 10px;">0.75 tsp turmeric</li>
<li style="font-size: 23px;padding: 10px;">1.5 tsp kashmiri red chilli powder</li>
<li style="font-size: 23px;padding: 10px;">0.75 tsp chaat masala</li>
<li style="font-size: 23px;padding: 10px;">1.5 tsp salt</li>
<li style="font-size: 23px;padding: 10px;">6 tbsp coriander (finely chopped)</li>
<li style="font-size: 23px;padding: 10px;">0.75 cup bread crumbs</li>
<h4 style="color: orange;font-size: 35px;">for slurry:</h4>
<li style="font-size: 23px;padding: 10px;">6 tbsp corn flour</li>
<li style="font-size: 23px;padding: 10px;">75 cup maida / plain flour</li>
<li style="font-size: 23px;padding: 10px;">1.5 cup water</li>
<h4 style="color: orange;font-size: 35px;">other ingredients:</h4>
<li style="font-size: 23px;padding: 10px;">3 cup panko breadcrumbs (for coating)</li>
<li style="font-size: 23px;padding: 10px;">oil (for frying)</li>
<li style="font-size: 23px;padding: 10px;">9 tbsp eggless mayonnaise</li>
<li style="font-size: 23px;padding: 10px;">few slices tomato</li>
<li style="font-size: 23px;padding: 10px;">few slices cucumber</li>
<li style="font-size: 23px;padding: 10px;">pinch salt</li>
<li style="font-size: 23px;padding: 10px;">few slices jalapeno</li>
<li style="font-size: 23px;padding: 10px;">pinch pepper powder</li>
<li style="font-size: 23px;padding: 10px;">9 slices cheese</li>
    </ul>
 </div>
        <div id="directions" class="tabcontent">
          <h3 style="color: orange;font-size: 40px;">DIRECTIONS</h3>
          <ul>
          <h4 style="color: orange;font-size: 35px;">Veg Patties Preparation</h4>
    <li style="font-size: 23px;padding: 10px;">Firstly, steam ½ carrot, 6 gobi, 4 beans, 2 tbsp sweet corn, 2 tbsp peas and ¼ tsp salt.</li>
    <li style="font-size: 23px;padding: 10px;">Steam for 10 minutes on medium flame.</li>
    <li style="font-size: 23px;padding: 10px;">Transfer the steamed vegetables to large mixing bowl.</li>
    <li style="font-size: 23px;padding: 10px;">Also, add 3 boiled and mashed potato.</li>
    <li style="font-size: 23px;padding: 10px;">Further, add ¼ tsp cumin powder, ½ tsp garam masala, ¼ tsp turmeric, ½ tsp chilli powder, ¼ tsp chaat masala and ½ tsp salt.</li>
    <li style="font-size: 23px;padding: 10px;">Add 2 tbsp coriander and mix well combining all the spices well.</li>
    <li style="font-size: 23px;padding: 10px;">Furthermore add ¼ cup bread crumbs and mix well. breadcrumbs help to absorb moisture from vegetables.</li>
    <li style="font-size: 23px;padding: 10px;">Prepare a slurry by mixing 2 tbsp cornflour, ¼ cup maida and ½ cup water in a small bowl.</li>
    <li style="font-size: 23px;padding: 10px;">Prepare ball sized patties and dip in maida slurry.</li>
    <li style="font-size: 23px;padding: 10px;">Coat with panko breadcrumbs uniformly.</li>
    <li style="font-size: 23px;padding: 10px;">Shallow fry in hot oil keeping the flame on medium.</li>
    <li style="font-size: 23px;padding: 10px;">Fry on both sides, until it turns golden brown. drain off and keep aside.</li>
    <h4 style="color: orange;font-size: 35px;">Burger preparation:</h4>
    <li style="font-size: 23px;padding: 10px;">Firstly, in a small bowl take 3 tbsp eggless mayonnaise, 2 tbsp tomato sauce and 1 tsp chilli sauce.</li>
    <li style="font-size: 23px;padding: 10px;">Mix well-forming burger sauce.</li>
    <li style="font-size: 23px;padding: 10px;">Spread a tbsp of prepared burger sauce on the bun.</li>
    <li style="font-size: 23px;padding: 10px;">Place a few slices of tomato, cucumber and jalapeno.</li>
    <li style="font-size: 23px;padding: 10px;">Sprinkle salt and pepper slightly.</li>
    <li style="font-size: 23px;padding: 10px;">Layer with a cheese slice.</li>
    <li style="font-size: 23px;padding: 10px;">Further place prepared patties and cover with another part of the bun.</li>
    <li style="font-size: 23px;padding: 10px;">Finally, enjoy veggie burger with chips and salad.</li>
...
<div id="time" class="tabcontent">
    ...
    <ul>
      <li style="font-size: 23px;padding: 10px;">40m preparation time</li>
    </ul>
  </div>
