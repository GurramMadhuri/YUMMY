...
<div class="wrapper">
  <div class="img">
        <img src="./images/veg manchuria.jpg">
  ...
  <div id="ingredients" class="tabcontent">
          ...
          <ul>
      <h4 style="color: orange;font-size: 35px;">For manchurian balls:</h4>
  <li style="font-size: 23px;padding: 10px;">3 carrot (grated)</li>
  <li style="font-size: 23px;padding: 10px;">15 tbsp cabbage (shredded)</li>
  <li style="font-size: 23px;padding: 10px;">15 tbsp spring onion (chopped)</li>
  <li style="font-size: 23px;padding: 10px;">1.5 onion (finely chopped)</li>
  <li style="font-size: 23px;padding: 10px;">1.5 tsp ginger garlic paste</li>
  <li style="font-size: 23px;padding: 10px;">3 tsp chilli sauce</li>
  <li style="font-size: 23px;padding: 10px;">1.5 tsp salt</li>
  <li style="font-size: 23px;padding: 10px;">6 tbsp maida / plain flour</li>
  <li style="font-size: 23px;padding: 10px;">6 tbsp cornflour</li>
  <li style="font-size: 23px;padding: 10px;">oil (for frying)</li>
  <h4 style="color: orange;font-size: 35px;">For gravy:</h4>
  <li style="font-size: 23px;padding: 10px;">6 tbsp oil</li>
  <li style="font-size: 23px;padding: 10px;">3 inch ginger (finely chopped)</li>
  <li style="font-size: 23px;padding: 10px;">9 clove garlic (finely chopped)</li>
  <li style="font-size: 23px;padding: 10px;">3 chilli (slit)</li>
  <li style="font-size: 23px;padding: 10px;">12 tbsp spring onion (chopped)</li>
  <li style="font-size: 23px;padding: 10px;">1.5 onion (finely chopped)</li>
  <li style="font-size: 23px;padding: 10px;">1.5 capsicum (sliced)</li>
  <li style="font-size: 23px;padding: 10px;">6 tbsp vinegar</li>
  <li style="font-size: 23px;padding: 10px;">6 tbsp soy sauce</li>
  <li style="font-size: 23px;padding: 10px;">3 tsp chilli sauce</li>
  <li style="font-size: 23px;padding: 10px;">6 tbsp tomato sauce</li>
  <li style="font-size: 23px;padding: 10px;">1.5 tsp pepper powder</li>
  <li style="font-size: 23px;padding: 10px;">0.75 tsp salt</li>
  <li style="font-size: 23px;padding: 10px;">3.75 cup water</li>
  <h4 style="color: orange;font-size: 35px;">For slurry:</h4>
  <li style="font-size: 23px;padding: 10px;">6 tsp cornflour</li>
  <li style="font-size: 23px;padding: 10px;">0.75 cup water</li>
        ...
        <div id="directions" class="tabcontent">
          ...
          <ul>
          <li style="font-size: 23px;padding: 10px;">Firstly, in a large bowl take 1 carrot, 5 tbsp cabbage, 2 tbsp spring onion, ½ onion and ½ tsp ginger garlic paste.</li>
    <li style="font-size: 23px;padding: 10px;">Also add 1 tsp chilli sauce, ½ tsp salt.</li>
    <li style="font-size: 23px;padding: 10px;">Mix well making sure everything is combined well,</li>
    <li style="font-size: 23px;padding: 10px;">Further, add 2 tbsp maida, 2 tbsp cornflour and mix well.</li>
    <li style="font-size: 23px;padding: 10px;">Form a soft dough adding maida if required.</li>
    <li style="font-size: 23px;padding: 10px;">Now prepare a small ball sized balls.</li>
    <li style="font-size: 23px;padding: 10px;">Deep fry in hot oil keeping the flame on medium.</li>
    <li style="font-size: 23px;padding: 10px;">Stir occasionally, until the balls turn golden brown.</li>
    <li style="font-size: 23px;padding: 10px;">Drain off the manchurian balls and keep aside.</li>
    <li style="font-size: 23px;padding: 10px;">Now in a large wok, heat 2 tbsp oil and saute 1 inch ginger, 3 clove garlic, 1 chilli and 2 tbsp spring onion.</li>
    <li style="font-size: 23px;padding: 10px;">Add ½ onion and stir fry on high flame.</li>
    <li style="font-size: 23px;padding: 10px;">Further, add ½ capsicum and stir fry until it shrinks slightly.</li>
    <li style="font-size: 23px;padding: 10px;">Add 2 tbsp vinegar, 2 tbsp soy sauce, 1 tsp chilli sauce, 2 tbsp tomato sauce, ½ tsp pepper powder and ¼ tsp salt.</li>
    <li style="font-size: 23px;padding: 10px;">Stir fry making sure all the sauces are well combined.</li>
    <li style="font-size: 23px;padding: 10px;">Add in 1¼ cup water and boil on medium flame.</li>
    <li style="font-size: 23px;padding: 10px;">In a small bowl take 2 tsp cornflour and ¼ cup water.</li>
    <li style="font-size: 23px;padding: 10px;">Mix well forming a lump-free slurry.</li>
    <li style="font-size: 23px;padding: 10px;">Pour in cornflour slurry and mix well.</li>
    <li style="font-size: 23px;padding: 10px;">Continue to boil until the gravy thickens and turns glossy.</li>
    <li style="font-size: 23px;padding: 10px;">Add in prepared veg manchurian balls, 2 tbsp spring onion and mix well.</li>
    <li style="font-size: 23px;padding: 10px;">Finally, serve veg manchurian gravy with fried rice.</li>
...
<div id="time" class="tabcontent">
    ...
    <ul>
      <li style="font-size: 23px;padding: 10px;">20m preparation time</li>
    </ul>
  </div>
