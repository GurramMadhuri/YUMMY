...
<div class="wrapper">
  <div class="img">
        <img src="./images/grapes-juice.jpg">
  ...
  <div id="ingredients" class="tabcontent">
          ...
          <ul>
        <li style="font-size: 23px;padding: 10px;">1 kg grapes</li>
        <li style="font-size: 23px;padding: 10px;"><sup>1</sup>&frasl;<sub>4 </sub>pink salt</li>
        <li style="font-size: 23px;padding: 10px;">1<sup>1</sup>&frasl;<sub>2</sub>inch ginger</li>
        <li style="font-size: 23px;padding: 10px;">1 <sup>1</sup>&frasl;<sub>4 </sub>tsp pepper corn</li>
        <h3 style="color: orange;font-size: 40px;">For cleaning</h3>
        <li style="font-size: 23px;padding: 10px;">2 tbsps Sea Salt</li>
        <li style="font-size: 23px;padding: 10px;">Vinegar</li>
        <li style="font-size: 23px;padding: 10px;">Water</li>
      </ul>
        </div>
        <div id="directions" class="tabcontent">
          <h3 style="color: orange;font-size: 40px;">DIRECTIONS</h3>
          <li style="font-size: 23px;padding: 10px;">Cleaning grapes</li>
      <li style="font-size: 23px;padding: 10px;"> Bring grapes to room temperature .</li>
      <li style="font-size: 23px;padding: 10px;">Sprinkle salt and spray vinegar.Set this aside for 10 to 15 mins.Meanwhile destem the grapes.Discard the rotten grapes,if any.</li>
      <li style="font-size: 23px;padding: 10px;">Add water just enough to cover the grapes.Rub them gently.Discard the Water. </li>
      <li style="font-size: 23px;padding: 10px;">Rinse them a few times with lot of water.if you like chilled jiuce,then chill or freeze them for 1 to 2 hours depending on how cold you want it to be.</li>
      <li style="font-size: 23px;padding: 10px;">If making in mixer or blender,cube them to 1 inch pieces. Add them to blender jar along with other ingredients.</li>
      <h3 style="color: orange;font-size: 40px;">Making grape juice</h3>
      <li style="font-size: 23px;padding: 10px;">If making it in blender,add grapes along with the desired ingredients.</li>
      <li style="font-size: 23px;padding: 10px;">Add water according to your taste,depending on how diluted you want it to be.</li>
      <li style="font-size: 23px;padding: 10px;">Place a strainer over a bowl and pour the grape juice.Using a spoon pass the juice through the strainer.Pour to serving glasses.If you want you can add ice cubes to it.</li>
      <li style="font-size: 23px;padding: 10px;">To make in slow juicer,follow the manufacturers manual & run the juicer.Add grapes to the juicer chute and collect the juice in the pitcher.</li>
      <li style="font-size: 23px;padding: 10px;"> Serve grape juice fresh and immediately.</li>
