...
<div class="wrapper">
  ...
  <div style="background-color:black" id="ingredients" class="tabcontent">
    ...
    <ul>
      <li style="font-size: 25px;padding: 20px;color: white">3 very ripe Red Tomatoes,1 Ginger piece</li>
      <li style="font-size: 25px;padding: 20px;color: white">1 cup Cashew nuts,3 Green chillies,4 Garlic Cloves</li>
      <li style="font-size: 25px;padding: 20px;color: white">2 Cardamoms,3 Cloves,2 Red Chillies,1/2 tsp Pepper</li>
      <li style="font-size: 25px;padding: 20px;color: white">1/4 cup Curd with Cream (malai),1/2 cup Oil</li>
      <li style="font-size: 25px;padding: 20px;color: white">150 gms Mushrooms,1 Onion Thinly Chopped,1 tsp Cumin seeds</li>
      <li style="font-size: 25px;padding: 20px;color: white">1/2 tsp Mirchi Powder,1/2 tsp Garam Masala</li>
      <li style="font-size: 25px;padding: 20px;color: white">1/2 tsp Dry Coriander Powder,2 tsps Kashmiri Mirchi Powder,1.5 tsps Salt</li>
      <li style="font-size: 25px;padding: 20px;color: white">350 ml Water,1 tbsp Ghee</li>
      <li style="font-size: 25px;padding: 20px;color: white">2 tbsps Chopped Green Coriander</li>
      <li style="font-size: 25px;padding: 20px;color: white">1/2 Lemon Juice
  ...
  <div id="directions" class="tabcontent">
    ...
    <ul>
      <li style="font-size: 23px;padding: 10px;">Add all the ingredients for the gravy to the mixer and grind to a soft paste without any fragments.</li>
      <li style="font-size: 23px;padding: 10px;">Heat oil and fry half of the Cashew Nuts.</li>
      <li style="font-size: 23px;padding: 10px;"> Add Mushrooms and fry until the Cashew Nuts turn lightly golden brown and set aside.</li>

      <li style="font-size: 23px;padding: 10px;">Add Cumin seeds, chopped onion, and fry until golden brown.</li>
 <li style="font-size: 23px;padding: 10px;">Mix Red Chilli Powder, Kashmiri Mirchi Powder, Garam Masala, Coriander powder and fry thoroughly.</li>
 <li style="font-size: 23px;padding: 10px;">Add the ground paste and let it cook for 3-4 minutes, add 350 ml of water and let the gravy cook until the oil separates.
</li>
<li style="font-size: 23px;padding: 10px;">
Add salt to taste.
When the oil separates, add Cashew Nuts and Mushrooms and let it cook for 3-4 minutes.</li>
 <li style="font-size: 23px;padding: 10px;">Add chopped Coriander and some ghee and let it cook for another minute.
</li>
      <li style="font-size: 23px;padding: 10px;"> 
Add the juice of a half slice of lemon and remove it from the flame.</li>
