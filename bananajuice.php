...
<div class="wrapper">
  <div class="img">
        <img src="./images/bananajuice.jpg">
  ...
  <div id="ingredients" class="tabcontent">
          ...
          <ul>
            <li style="font-size: 23px;padding: 10px;">2 Large Bananas</li>
            <li style="font-size: 23px;padding: 10px;"><sup>1</sup>&frasl;<sub>2</sub> Apple,cored and chopped</li>
            <li style="font-size: 23px;padding: 10px;">1 tablespoon Honey</li>
            <li style="font-size: 23px;padding: 10px;">1 <sup>1</sup>&frasl;<sub>2</sub> cups Milk or Water(Milk is preferable)</li>
          </ul>
        </div>
        <div id="directions" class="tabcontent">
          <h3 style="color: orange;font-size: 40px;">DIRECTIONS</h3>
          <li style="font-size: 23px;padding: 10px;">Wash the bananas and apple,and pat dry them.</li>
          <li style="font-size: 23px;padding: 10px;">peel the bananas and cut into slices.Peel and cut apple into halves.Take one portion and cut into medium pieces,keep another half for other use.</li>
          <li style="font-size: 23px;padding: 10px;">Add banana chunks,apple pieces and honey in a blender jar</li>
          <li style="font-size: 23px;padding: 10px;">add milk.(use milk for better taste or use water to make it a low calorie juice)</li>
          <li style="font-size: 23px;padding: 10px;">Blend all Ingredients together until smooth puree.</li>
          <li style="font-size: 23px;padding: 10px;">Check consistency,if you feel that its too thick,then add more milk to dilute it and blend it again for 5 seconds.
            Pour it into serving glasses,garnish with a banana wheel and serve</li>
