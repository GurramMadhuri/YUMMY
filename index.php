  ...
  <div  class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="index.php" style="font-size: 25px;">Login <span class="sr-only">(current)</span></a>
      </li>

    

      <li class="nav-item">
        <a class="nav-link" href="register.php" style="font-size: 25px;">Register</a>
      </li>
      ...
      <div class="card-body">
        <form>
          ...
          <div class="form-group">
            <a class="btn float-right login_btn" href="home.php">Login</a>
          </div>
        </form>
      </div>
      <div class="card-footer">
        <div style="color: inherit;color: white" class="d-flex justify-content-center links">
          <a href="register.php" style="width:auto;cursor:pointer;color: inherit;color: white;font-size: 18px;text-decoration: none">Don't have an account? Sign Up</a>
        </div>
        <div class="d-flex justify-content-center">
          <a href="forgetpassword.php" style="width:auto;cursor:pointer;color: inherit;color: white;font-size: 18px;text-decoration: none">Forgot your password?</a>
        </div>
      </div>
    </div>
  </div>
