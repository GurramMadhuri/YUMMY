    ...
    <div class="card">
      ...
      <div class="card-body">
        <form>
          ...
          <div class="form-group">
            <a class="btn float-right login_btn" href="home.html">Reset</a>
          </div>
        </form>
      </div>
      ...
      <div class="card-footer">
        <div style="color: inherit;color: white" class="d-flex justify-content-center links">
          <a href="index.php" style="width:auto;cursor:pointer;color: inherit;color: white;font-size: 18px;text-decoration: none">Login!!</a>
        </div>
