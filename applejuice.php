...
<div class="wrapper">
  <div class="img">
        <img src="./images/apple-juice-recipe.jpg">
  ...
  <div id="ingredients" class="tabcontent">
    ...
    <ul>
      <li style="font-size: 23px;padding: 10px;">4 Apples preferably low acid kind</li>
        <li style="font-size: 23px;padding: 10px;"><sup>1</sup>&frasl;<sub>2 </sub>lemon small,(skip if using sour apples)</li>
        <li style="font-size: 23px;padding: 10px;">1 pinch pink salt.</li>
        <li style="font-size: 23px;padding: 10px;">1 cup water or orange juice or any fruit juice needed(if making in a blender).</li>
        <li style="font-size: 23px;padding: 10px;">1 <sup>1</sup>&frasl;<sub>2 </sub>inch ginger piece.</li>
        <li style="font-size: 23px;padding: 10px;">1 handful holy basil(tulsi)or mint leaves(pudina).</li>

    </ul>
  </div>
  <div id="directions" class="tabcontent">
    <h3 style="color: orange;font-size: 40px;">DIRECTIONS</h3>
    <li style="font-size: 23px;padding: 10px;">Wash 4 apples under running water.</li>
    <li style="font-size: 23px;padding: 10px;">if you prefer to use the skin,then make sure they are at room tempeature and spray vinegar.
      Set these aside for 5mins.Rub them gently with salt and rinse off under running water.</li>
    <li style="font-size: 23px;padding: 10px;">Cut the chunks of apples and remove the core and seeds. </li>
    <li style="font-size: 23px;padding: 10px;">Add them a chunks of apples and other Ingredients to a blender.if you using a juicer,then run the machine and add them to the chute.</li>
    <li style="font-size: 23px;padding: 10px;">if made in a blender,pass it through a strainer.</li>
    <li style="font-size: 23px;padding: 10px;"> Add water until the consistency. Serve the  Apple juice fresh immediately.</li>
  </div>
  <div id="time" class="tabcontent">
    <h3 style="color: orange;font-size: 40px;">ESTIMATED TIME</h3>
    <ul>
      <li style="font-size: 23px;padding: 10px;">10m preparation time</li>
      <li style="font-size: 23px;padding: 10px;">10m total</li>
    </ul>
  </div>
