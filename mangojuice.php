...
<div class="wrapper">
  <div class="img">
        <img src="./images/mangojuice.jfif">
  ...
  <div id="ingredients" class="tabcontent">
          ...
          <ul>
        <li style="font-size: 23px;padding: 10px;">3 medium mangoes or 1 large or large <sup>1</sup>&frasl;<sub>2 </sub>large cups frozen or canned pulp. </li>
          <li style="font-size: 23px;padding: 10px;"><sup>1</sup>&frasl;<sub>2 </sub>cups to 2cups chilled water or coconut water from young coconuts or orange juice.</li>
          <li style="font-size: 23px;padding: 10px;">3 tablespoons sugar or manuka honey(adjust to taste)</li>
          <li style="font-size: 23px;padding: 10px;">1 <sup>1</sup>&frasl;<sub>2 </sub>inch ginger piece.</li>
          <h3 style="color: orange;font-size: 40px;">Optional</h3>
          <li style="font-size: 23px;padding: 10px;">5 to 6 mint leaves for flavour</li>
          <li style="font-size: 23px;padding: 10px;">1 inch ginger(fresh root)</li>
          <li style="font-size: 23px;padding: 10px;">1 lemon or lime</li>
         <li style="font-size: 23px;padding: 10px;">2 tbsps chia seeds or sabja seeds.</li>
      </ul>
        </div>
        <div id="directions" class="tabcontent">
          <h3 style="color: orange;font-size: 40px;">DIRECTIONS</h3>
          <li style="font-size: 23px;padding: 10px;">Wash mango thoroughly and chill them in the fridge .peel the skin</li>
      <li style="font-size: 23px;padding: 10px;">Cut the mango to cubes and add them to a blender.</li>
      <li style="font-size: 23px;padding: 10px;">Pour the coconut water or orange juice or water.Add sugar and ice cubes.If using Ice cubes.reduce the liquid.</li>
      <li style="font-size: 23px;padding: 10px;">Optional-Put in the other ingredients if using like ginger and mint.</li>
      <li style="font-size: 23px;padding: 10px;"> Blend until smooth.Pour more liquid if needed to your taste.Serve immmediately.</li>
      <li style="font-size: 23px;padding: 10px;">If using chia seeds or sabja seeds,then rinse them thoroughly in a strainer.Soak in 1cup water and set aside for atleast 20  mins to 2 hours. </li>
      <li style="font-size: 23px;padding: 10px;">Stir them in the juice just before serving.</li>
      <li style="font-size: 23px;padding: 10px;">Serve mango juice immediately.</li>
