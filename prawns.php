...
<div class="wrapper">
  <div class="img">
    <img src="./images/frawnsbiryani.jpg">
  </div>
  <div class="title">
...
<div style="background-color:black" id="ingredients" class="tabcontent">
  ...
  <ul>
    <li style="font-size: 25px;padding: 20px;color: white">250 gms Prawns</li>
<li style="font-size: 25px;padding: 20px;color: white">220 gms Basmati Rice (Salted, boiled and cooled)</li>
<li style="font-size: 25px;padding: 20px;color: white">1/4 cup Oil
1 tbsp Ghee</li>
<li style="font-size: 25px;padding: 20px;color: white">1 Sliced Onion
4 Green Chillies</li>
<li style="font-size: 25px;padding: 20px;color: white">2 tbsps Green Coriander</li>
<li style="font-size: 25px;padding: 20px;color: white">2 tbsps Chopped Mint,Leaves,1 tbsp Ginger Garlic Paste</li>
<li style="font-size: 25px;padding: 20px;color: white">1.5 tbsp Red Mirchi</li>
<li style="font-size: 25px;padding: 20px;color: white">1/2 tsp Turmeric,
1 tsp Garam Masala</li>
  ...
  <div id="directions" class="tabcontent">
    ...
    <ul>
      <li style="font-size: 23px;padding: 10px;">Heat Oil, add Turmeric and raw Prawns and fry until water evaporates and oil separates. Remove them into a bowl.</li>
      <li style="font-size: 23px;padding: 10px;">In the same pan, add another 2 tsp of oil and fry sliced Onions well.</li>
     <li style="font-size: 23px;padding: 10px;">When the Onions are fried more than half, add the sliced Green Chillies.</li>

 
<li style="font-size: 23px;padding: 10px;">While the Onions are frying, add Ginger Garlic paste. Add Mirchi Powder, Salt and Garam Masala and fry well.</li>
<li style="font-size: 23px;padding: 10px;">Now add the Prawns and fry for another three minutes.</li>
<li style="font-size: 23px;padding: 10px;"> Add the fluffy Rice and mix well. Sprinkle chopped Mint and Coriander leaves and Ghee, mix well and remove from fire. Serve hot with Raitha.</li>
