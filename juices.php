...
<!-- Navbar ends -->
 ...
 <section style="padding: 20px;" class="popular" id="popular">
      ...
      <h1 class="heading"> JUICES </h1>

      <div class="box-container">

          <div class="box">

              <img src="./images/apple-juice-recipe.jpg" alt="">
              <h3>APPLE JUICE</h3>
              <a href="applejuice.php" class="btn">View More</a>
          </div>
          <div class="box">

              <img src="./images/bananajuice.jpg" alt="">
              <h3>BANANA JUICE</h3>
              <a href="bananajuice.php" class="btn">View More</a>
          </div>
          <div class="box">

              <img src="./images/carrotjuice.jpg" alt="">
              <h3>CARROT JUICE</h3>
              <a href="carrotjuice.php" class="btn">View More</a>
          </div>
          <div class="box">

              <img src="./images/grapes-juice.jpg" alt="">
              <h3>GRAPE JUICE</h3>
              <a href="grapejuice.php" class="btn">View More</a>
          </div>
          <div class="box">

              <img src="./images/mangojuice.jfif" alt="">
              <h3>MANGO JUICE</h3>
              <a href="mangojuice.php" class="btn">View More</a>
          </div>
          <div class="box">

              <img src="./images/promograntejuice.jfif" alt="">
              <h3>PROMOGRANATE</h3>
              <a href="promogranate.php" class="btn">View More</a>
          </div>
