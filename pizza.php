...
<div class="wrapper">
  ...
  <div id="ingredients" class="tabcontent">
          ...
          <ul>
      <h4 style="color: orange;font-size: 35px;">For Pizza Crust</h4>
<li style="font-size: 23px;padding: 10px;">3 to 3.25 cups all-purpose flour or bread flour (unbleached), 375 grams</li>
<li style="font-size: 23px;padding: 10px;">½ teaspoon sugar</li>
<li style="font-size: 23px;padding: 10px;">1 cup warm water or add as required</li>
<li style="font-size: 23px;padding: 10px;">1.5 teaspoons instant yeast 4 to 5 grams or 2 teaspoons dry active yeast</li>
<li style="font-size: 23px;padding: 10px;">3 tablespoons olive oil</li>
<li style="font-size: 23px;padding: 10px;">1 teaspoon salt or add as required</li>
<li style="font-size: 23px;padding: 10px;">1 to 2 teaspoons olive oil for brushing dough</li>
<li style="font-size: 23px;padding: 10px;">semolina or cornmeal (makki ka atta) or all-purpose flour for sprinkling on pan</li>
<h4 style="color: orange;font-size: 35px;">For Pizza Sauce</h4>
<li style="font-size: 23px;padding: 10px;">5 to 6 medium tomatoes – 500 grams</li>
<li style="font-size: 23px;padding: 10px;">2 teaspoons minced garlic or 8 to 10 small to medium garlic cloves, 5 grams peeled garlic</li>
<li style="font-size: 23px;padding: 10px;">¼ cup olive oil</li>
<li style="font-size: 23px;padding: 10px;">¼ cup chopped basil or 3 to 4 teaspoons dried basil</li>
<li style="font-size: 23px;padding: 10px;">2 teaspoons dried oregano or 2 tablespoons fresh oregano</li>
<li style="font-size: 23px;padding: 10px;">freshly crushed black pepper or ground black pepper, as required</li>
<li style="font-size: 23px;padding: 10px;">salt as required</li>
    </ul>
 </div>
        <div id="directions" class="tabcontent">
          <h3 style="color: orange;font-size: 40px;">DIRECTIONS</h3>
          <ul>
          <h4 style="color: orange;font-size: 35px;">Making doughs</h4>
      <li style="font-size: 23px;padding: 10px;">First, in a large bowl mix together 1.5 teaspoons instant yeast and ½ teaspoon of sugar.</li>
      <li style="font-size: 23px;padding: 10px;">Add 1 cup of lukewarm water (44 degrees Celsius) and stir. Set aside and let the yeast activate.</li>
       <li style="font-size: 23px;padding: 10px;">You should start to see the yeast mixture bubbling up and doubling in size after about 10 to 15 minutes.</li>
      <li style="font-size: 23px;padding: 10px;">Combine 1 cup of unbleached all purpose flour (or bread flour) with 1 teaspoon of salt and 3 tablespoons of olive oil.</li>
      <li style="font-size: 23px;padding: 10px;">Stir with a whisk or wooden spoon or steel spoon.</li>
      <li style="font-size: 23px;padding: 10px;">Add one more cup of the flour.</li>
      <li style="font-size: 23px;padding: 10px;">Keep on stirring. The mixture will be quite sticky.</li>
      <li style="font-size: 23px;padding: 10px;"> Add the last cup of flour and continue to stir. The dough will start to form and leave the sides of the bowl, but will still be sticky.</li>
      <li style="font-size: 23px;padding: 10px;">Now it’s time to knead the dough by hand until it forms a smooth dough. Dust with flour to prevent sticking as you work. The dough will be soft and elastic, and no longer sticky.</li>
      <li style="font-size: 23px;padding: 10px;">Keep your dough in the deep bowl, and lightly apply a bit of olive oil all around the outside of the dough. This will keep it from sticking to the sides of the bowl once the dough proves and grows.</li>
      <li style="font-size: 23px;padding: 10px;">After exactly 1 hour my dough had risen and doubled up to what you see below.</li>
      <li style="font-size: 23px;padding: 10px;">If you plan to make the pizza the next day, then wrap the dough tightly in a plastic wrap and keep in the fridge.</li>
       <li style="font-size: 23px;padding: 10px;">To make the pizza right away, portion and flatten the dough to a disk. In the below photo, you can see that the dough has leavened well, with stringy strands and many air pockets that will make a chewy crust.</li>
      <h4 style="color: orange;font-size: 40px;">Making Pizza Sauce from scratch</h4>
      <li style="font-size: 23px;padding: 10px;">You can choose to either chop the tomatoes (500 grams or 5 to 6 medium tomatoes) and use them fresh to make the sauce, or blanch them first and then add in a blender.
        Blanching will reduce the cooking time, but is not necessary for making a delicious sauce.</li>
      <li style="font-size: 23px;padding: 10px;">Crush the raw or blanched tomatoes in the blender to make a puree that is as smooth or chunky as you like for this pizza recipe.</li>
      <li style="font-size: 23px;padding: 10px;">Next, in a large sauce pan heat ¼ cup olive oil, and add 2 teaspoons minced garlic. Sauté and stir for some seconds to soften the garlic.
      Now add the tomato puree, and mix well.</li>
       <li style="font-size: 23px;padding: 10px;">Continue stirring and let the tomatoes cook for 5 minutes.</li>
       <li style="font-size: 23px;padding: 10px;">Add salt as needed. Mix and stir.</li>
      <li style="font-size: 23px;padding: 10px;">Cover the pan with lid and simmer the tomato sauce on low heat for 20 minutes, stirring occasionally, until the tomatoes have softened.
        If the sauce looks too thick you can add ¼ cup water. Then cover and continue to cook.</li>
      <li style="font-size: 23px;padding: 10px;">Simmer until the tomatoes have completely cooked and the sauce has thickened.</li>
      <li style="font-size: 23px;padding: 10px;">Stir in herbs and crushed black pepper.</li>
      <li style="font-size: 23px;padding: 10px;">Mix the sauce well and set aside.</li>
      <h4 style="color: orange;font-size: 40px;">Assembling and baking</h4>
      <li style="font-size: 23px;padding: 10px;">First, preheat the oven to the highest temperature in your oven.
        In my oven it is 230 degrees Celsius (450 degrees Fahrenheit).
        Grease a round metal baking pan with olive oil, and then lightly dust it with maize flour (cornmeal), semolina (rava or sooji) or flour.</li>
       <li style="font-size: 23px;padding: 10px;">Divide the pizza dough into equals parts to make either 4 small or 2 large or 3 medium size pizzas.
         Wrap any dough you’re not using in plastic wrap and keep in the fridge for up to 3 days total.</li>
       <li style="font-size: 23px;padding: 10px;">Using clean, dry hands, take one portion of the divided dough and roll it into a neat round ball.
         Place on a cutting board or countertop that’s been lightly coated with some flour, and sprinkle the dough with a light dusting of more flour.</li>
       <li style="font-size: 23px;padding: 10px;">Use a rolling pin to roll the dough ball into a large round or oval shape of about ⅛ to ¼ inch thickness.
         Roll the dough from the center towards the outer edges for the most even pizza dough. You may have to dust the surface with flour as you work.</li>
      <li style="font-size: 23px;padding: 10px;">Once stretched to the desired size, gently place the pizza base in the greased baking pan. Be careful not to tear the dough, as it is very soft and stretchy.</li>
       <li style="font-size: 23px;padding: 10px;">At this point you can prick the dough with a fork if you want a thinner, crisper crust. This also helps in the crust not puffing up when baking.
         However, you can leave the dough as-is for a fluffier, chewier veg pizza crust.</li>
      <li style="font-size: 23px;padding: 10px;">Use a pastry brush to lightly brush the surface of the crust with olive oil.</li>
      <li style="font-size: 23px;padding: 10px;">Then, spread the tomato sauce on the pizza in a thin, even layer. Leave about an inch of dough around the outer edge free from sauce for a perfect pizza crust.</li>
      <li style="font-size: 23px;padding: 10px;">Top the sauce with a generous handful or two of shredded mozzarella cheese.</li>
       <li style="font-size: 23px;padding: 10px;">Place your choice of veggies on top of the cheese, making sure to spread the toppings evenly.</li>
      <li style="font-size: 23px;padding: 10px;"> Next, add a light layer of grated parmesan cheese to finish the pizza.</li>
      <li style="font-size: 23px;padding: 10px;"> Place the baking pan close to the lower heating element (or you can keep it even on the crumb tray of your OTG) to get the crispiest crust and perfectly molten, gooey melted cheese.
        Bake the veg pizza in the preheated oven for 10 to 15 minutes, until the cheese melts and the crust is golden.</li>
      <li style="font-size: 23px;padding: 10px;">Your perfect personalized veg pizza is now ready to enjoy!</li>
   </ul>
</div>
<div id="time" class="tabcontent">
    <h3 style="color: orange;font-size: 40px;">Esimated Time</h3>
    <ul>
      <li style="font-size: 23px;padding: 10px;">10m preparation time</li>
    </ul>
  </div>
<div id="serving" class="tabcontent">
  <h3 style="color: orange;font-size: 40px;">SERVING</h3>
  <li style="font-size: 23px;padding: 10px;">This specific recipe serves up to two people. Adjust it accordingly to suit the specific needs of your party.</li>
</div>
</div>
</body>
<script>
