...
<div class="wrapper">
  ...
  <div style="background-color:black" id="ingredients" class="tabcontent">
    ...
    <ul>
      <li style="font-size: 25px;padding: 20px;color: white">1/2 kilo Chicken</li>
     <li style="font-size: 25px;padding: 20px;color: white">1 tbsp Mirchi Powder</li>
<li style="font-size: 25px;padding: 20px;color: white">1/4 cup Pepper Powder<?
<li style="font-size: 25px;padding: 20px;color: white">Water,
Salt</li>
<li style="font-size: 25px;padding: 20px;color: white">1/2 kilo Fish Pieces</li>
<li style="font-size: 25px;padding: 20px;color: white">1/4 cup Oil</li>
<li style="font-size: 25px;padding: 20px;color: white">1/2 tsp Fennel Seeds
,1/2 tsp Cumin Seeds</li>
<li style="font-size: 25px;padding: 20px;color: white">20 Garlic pieces</li>
<li style="font-size: 25px;padding: 20px;color: white">7 Red Chillies,
12 Onions,1/4 tsp Turmeric</li>
<li style="font-size: 25px;padding: 20px;color: white">10 Sprigs Curry leaves</li>
<li style="font-size: 25px;padding: 20px;color: white">1/4 cup Raw Coconut</li>
<li style="font-size: 25px;padding: 20px;color: white">2 tbsp Coriander Powder</li>
<li style="font-size: 25px;padding: 20px;color: white">2.5 tbsp Mirchi Powder</li>
<li style="font-size: 25px;padding: 20px;color: white">3 Tomatoes (finely chopped)</li>
<li style="font-size: 25px;padding: 20px;color: white">Tamarind – Lemon sized
1 tsp Mustard Seeds</li>
<li style="font-size: 25px;padding: 20px;color: white">1/4 tsp Fenugreek Seeds</li>
<li style="font-size: 25px;padding: 20px;color: white">Green Coriander – Small bunch</li>
  ...
  <div id="directions" class="tabcontent">
    ...
    <ul>
      <li style="font-size: 23px;padding: 10px;">On a plate, add some Mirchi Powder, Salt, Pepper Powder and some Water and make a paste. Coat the Fish pieces with the paste and let it rest.</li>
     <li style="font-size: 23px;padding: 10px;">Heat Oil in a pan and add Pepper, Cumin Seeds, fennel Seeds, Red Chillies and Garlic and fry well. Then add the chopped Onions, Curry Leaves and Turmeric and cover and cook until Onions soften.</li>
    <li style="font-size: 23px;padding: 10px;">In the Onions, add the Raw Coconut pieces, Coriander Powder, Mirchi Powder, Tomato pieces and Green Coriander and let it cook on medium flame until the Oil comes to the surface.</li>

 
     <li style="font-size: 23px;padding: 10px;">Once the tomatoes are cooked, add to a mixie jar along with Tamarind juice and make a soft paste with it.</li>
    <li style="font-size: 23px;padding: 10px;">Heat Oil in a pan and add Mustard Seeds and Fenugreek Seeds and let the Mustard Seeds splutter.</li> 

      <li style="font-size: 23px;padding: 10px;">Then add Fennel Seeds, Cumin, Curry Leaves, Garlic, Green Chillies and the Sambar Onions and fry until golden.</li>
    <li style="font-size: 23px;padding: 10px;">Take the Tomatoes, made into a paste with the Tamarind Water and add Rock Salt, and cook on a low flame until it changes colour and the Oil separates. </li>

      <li style="font-size: 23px;padding: 10px;">Then you get thick, tasty Gravy.</li>

 
     <li style="font-size: 23px;padding: 10px;">Then add 300 ml Water and cook the Gravy on a medium flame for 15 minutes and Oil comes to the surface. </li>

      <li style="font-size: 23px;padding: 10px;">Then add the Fish pieces, and Fish Eggs if you have them, cover it and cook on a low flame until Oil separates.</li>

    <li style="font-size: 23px;padding: 10px;">Then add Green Coriander along with stalks, Curry Leaves along with stalks and switch off the stove and leave it untouched for an hour.</li>

    <li style="font-size: 23px;padding: 10px;"> Then serve the Stew with hot Rice, Chapathi, Dosa or Idly.</li>
  ...
  <div id="time" class="tabcontent">
    ...
    <ul>
      <li style="font-size: 23px;padding: 20px;">35m preparation time</li>
    </ul>
  </div>
